      ...
      <footer className="footer sm:footer-horizontal bg-base-300 text-base-content p-10">
        ...
        <nav>
          ...
          <div className="grid grid-flow-col gap-4">
            ...
            <a href="https://www.instagram.com/gtomyasek" title="Instagram">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <a href="https://www.threads.net/@gtomyasek" title="Threads">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <a href="https://youtube.com/gtomy" title="Youtube">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
